...
| pdf-002 | Product PDF | Negotiation Script Pack — 6 Scripts + 6 Email Templates + Objection Guide ($67) | Claude Code | pending | pending | no | **Draft written 2026-04-24 16:xx EDT (D2-8 pull-forward by ops-controller 16:07 run)** — file: `content/pdfs/pdf-002-negotiation-scripts.md`. Covers: Introduction (600w), Scripts 1–6 with word-for-word dialogue + 6 email templates, Objection-Handling Quick Reference (8 items), Pre-Negotiation Checklist (12 items). Cells: mgma-im-median-comp, mgma-im-panel-median, shm-hospitalist-median-comp, nocturnist differential %. Gate 1 (Perplexity) blocked until IM_DATA_2026.md populated. Gate 2 (claude-chat-opus owner review) pending. |
| pdf-003 | Product PDF | wRVU Playbook — Understand Your Pay ($47) | Claude Code | pending | pending | no | **Draft written 2026-04-24 16:xx EDT (D2-8 pull-forward by ops-controller 16:07 run)** — file: `content/pdfs/pdf-003-wrvu-playbook.md`. Covers: 11 chapters (Parts I–IV) + 6 appendices (wRVU CPT table, benchmark card, red flag quick ref, state non-compete summary, glossary, resources). Appendix A: all CPT wRVU values use [VERIFY: 2026 CMS PFS] — must be confirmed before Gate 1 PASS. Appendix B: all benchmark figures use [DATA::cell-name]. Gate 1 critical: Appendix A (wRVU values per code) + Appendix B (MGMA P25/P50/P75) + Appendix D (state non-compete law). Gate 2 (claude-chat-opus owner review) pending. |
| pdf-004 | Product PDF | Hospitalist Shift Economics Analyzer ($37) | Claude Code | pending | pending | no | **Draft written 2026-04-24 16:xx EDT (D2-8 pull-forward by ops-controller 16:07 run)** — file: `content/pdfs/pdf-004-shift-economics.md`. Covers: Introduction, Parts 1–5 (7-on/7-off math, nocturnist pay, revenue streams, benchmarks, contract terms), Closing Action. Data cells: locum per-shift rate, SHM nocturnist diff %, SHM hospitalist P25/P50/P75, CMS professional fee rates for hospital codes. Gate 1 (Perplexity) blocked until IM_DATA_2026.md populated. Gate 2 (claude-chat-opus owner review) pending. |
